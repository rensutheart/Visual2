...
amdRequire(['vs/editor/editor.main'], function () {
  ...
  monaco.languages.setMonarchTokensProvider('arm', {
    ...
    keywords: [
      ...
      "BMI","BNE","BCC","BPL","BVC","BVS",
      "BX","BXCS","BXEQ","BXGE","BXGT","BXHI","BXHS","BXLE","BXLO","BXLS","BXLT","BXMI","BXNE","BXCC","BXPL","BXVC","BXVS",
      "BLX","BLXCS","BLXEQ","BLXGE","BLXGT","BLXHI","BLXHS","BLXLE","BLXLO","BLXLS","BLXLT","BLXMI","BLXNE","BLXCC","BLXPL","BLXVC","BLXVS",
      "END","ENDCS","ENDEQ","ENDGE","ENDGT","ENDHI","ENDHS","ENDLE","ENDLO",
      ...
      "PUSH","PUSHEQ","PUSHNE","PUSHMI","PUSHPL","PUSHHI","PUSHHS","PUSHLO","PUSHLS","PUSHGE","PUSHGT",
      "PUSHLE","PUSHLT","PUSHVS","PUSHVC","PUSHCC","PUSHCS",
      "POP","POPEQ","POPNE","POPMI","POPPL","POPHI","POPHS","POPLO","POPLS","POPGE","POPGT",
      "POPLE","POPLT","POPVS","POPVC","POPCC","POPCS",],
