...
let reLoadProgram (lines : string list) =
    ...
    let reLoadProgram' (lines : string list) =
        ...
        let rec pass lim1 lim2 =
            ...
            | n1, n2 when (n2 = 0 && lim2.LoadP.PosI <= lim2.LoadP.DStart && lim1.SymInf.Defs = lim2.SymInf.Defs) || (n2 <> 0 && n1 = n2)
                -> lim2
            | n1, n2 when n1 = n2 && List.isEmpty lim2.Errors && lim2.LoadP.PosI <= lim2.LoadP.DStart && lim1.SymInf.Defs = lim2.SymInf.Defs->
